...
const AddCourses = ({ open, onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // 4️⃣ Universities
            // Send text as JSON
            // Send logos separately using field name "universities"
            // =========================
            ...
            // 5️⃣ Testimonials
            // Send text as JSON
            // Send photos separately using field name "testimonials"
            // =========================
            ...
            fetchCourses(); // Refresh the courses list after adding a new program
                                ...
                                <section>
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input value={formData.university} required name="university" className={inputStyle} onChange={handleChange} />
                                        </div>
                                        <div>
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            <input required type="file" name="imageUrl" accept="image/*" onChange={handleChange} />
                                        </div>
                                    </div>
                                </section>
